...
int main(){
	...
	SecurityManager<int>* security = new SecurityManager<int>(0, 0, (char*)"Eldar");
	SecurityManager<int> man;
	...
	cs->sellTickets(visitors, concert1, cl, sm, sn);
	cs->sellTickets(visitors + 1, concert1, cl, sm, sn);
